...
public class Main {
    public static void main(String[] args)  throws IOException, JAXBException, FileNotFoundException // read braucht Exception, JAXB auch, FileNotFoundException - signalisiert, dass ein Versuch, die durch einen angegebenen Pfadnamen angegebene Datei zu öffnen, fehlgeschlagen ist
    {
